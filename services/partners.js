...
exports.getPartnerList = function (input, next) {
    Partner.find().deepPopulate(['_workerDetail', '_workerDetail._profileDetail', '_workerDetail._profileDetail._userDetail']).exec(function (err, object) {
        next(err, object);
    });
};

exports.getPartnerListLimited = function (input, next) {
    Partner.find({_workerDetail: input}).deepPopulate(['_workerDetail', '_workerDetail._profileDetail', '_workerDetail._profileDetail._userDetail']).exec(function (err, object) {
        next(err, object);
    });
};

exports.addPartner = function (input, next) {
    if (input.nickname == '') {
...
exports.deletePartner = function (input, res, next) {
    Partner.findById(input, function (err, object) {
...
exports.editPartnerProfiles = function (input, next) {
    ...
    Partner.findByIdAndUpdate(input.editPartnerID, option, function (err, object) {
        if (err) throw err;
        next(err, object);
    });
};

exports.findPartner = function (input, next) {
    Partner.findOne({partnerID: input}, function (err, user) {
        next(err, user);
    });
};